...
class mixture_var_saver(keras.callbacks.Callback):
    def on_epoch_end(self, epoch):
        tf.train.Saver(var_list=['mus:0','rhos:0','mix_logits:0'],filename=MODELS_FOLDER+'/mixture_params')
